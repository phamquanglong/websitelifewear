...
var CategoriesDiv = (props) => {
  ...
  return (
    <>
      <div
        className={`absolute top-20 left-1/3 w-screen z-10`}
        ...
        <div className="rounded-md bg-white shadow-md w-fit">
          {categories.map((i) => (
                  ...
                  if (item.name === i.name) {
                    return {
                      ...
                      childrenVisible:
                        ...
                        item.childrenVisible === undefined
                          ? true
                          : false,
                    };
                  }
            ...
            >
              <div
                onClick={() =>
                  navigate("/Categories", { state: { name: i.name, id: i.id } })
                }
              ...
              {i.childrenVisible === true && (
                <div
                  className={`z-10 bg-white shadow-md rounded-xl absolute left-80 max-w-xl ${
                    i.children.length > 5 ? "flex flex-wrap" : ""
                  }`}
                >
                  {i.children.map((item) => (
                    <div
                    ...
                    >
                      <p
                        className={`p-5 hover:rounded-md hover:bg-${colors.hover} cursor-pointer`}
                      >
                        {item.name}
                      </p>
                    </div>
